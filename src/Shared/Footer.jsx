const Footer = () => {
  return (
    <footer className="bg-[#EBEDEE] dark:bg-gray-900  text-gray-500">
          ...
          <div className="mb-6 md:mb-0">
            <a href="https://flowbite.com/" className="flex items-center">
              <img
                ...
                alt="FlowBite Logo"
              />
              <span className="self-center text-2xl font-semibold whitespace-nowrap text-[#836b6c]  dark:text-white">
                Wedding Weave
              </span>
            </a>
          </div>
